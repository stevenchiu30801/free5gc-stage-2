...
const char *go_member_name(arg_t *, asn1p_expr_t *);     /* %s%s (Title + Title) */
const char *c_presence_name(arg_t *, asn1p_expr_t *);   /* %s_PR_%s */
const char *go_presence_name(arg_t *, asn1p_expr_t *);   /* %sPresent%s */
