...
func (a *Message) GmmMessageDecode(byteArray *[]byte) {
...
func (a *Message) GmmMessageEncode(buffer *bytes.Buffer) {
	switch a.GmmMessage.GmmHeader.GetMessageType() {
	case MsgTypeRegistrationRequest:
...
func (a *Message) GsmMessageDecode(byteArray *[]byte) {
	buffer := bytes.NewBuffer(*byteArray)
...
func (a *Message) GsmMessageEncode(buffer *bytes.Buffer) {
	switch a.GsmMessage.GsmHeader.GetMessageType() {
	case MsgTypePDUSessionEstablishmentRequest:
