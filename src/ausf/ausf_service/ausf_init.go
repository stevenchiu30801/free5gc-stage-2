...
import (
	...
	"gofree5gc/src/app"
	"gofree5gc/src/ausf/UEAuthentication"
	"gofree5gc/src/ausf/ausf_consumer"
	"gofree5gc/src/ausf/ausf_context"
	"gofree5gc/src/ausf/ausf_handler"
	"gofree5gc/src/ausf/ausf_util"
	"gofree5gc/src/ausf/factory"
...
func (*AUSF) Initialize(c *cli.Context) {
	...
	if config.ausfcfg != "" {
		...
		DefaultAusfConfigPath := path_util.Gofree5gcPath("gofree5gc/config/ausfcfg.conf")
