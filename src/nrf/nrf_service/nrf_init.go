...
func (*NRF) Initialize(c *cli.Context) {
	...
	if config.nrfcfg != "" {
		...
		factory.InitConfigFactory(path_util.Gofree5gcPath("gofree5gc/config/nrfcfg.conf"))
	}
