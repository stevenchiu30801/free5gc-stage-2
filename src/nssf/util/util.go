...
var (
	NSSF_LOG_PATH = path_util.Gofree5gcPath("gofree5gc/nssfsslkey.log")
	NSSF_PEM_PATH = path_util.Gofree5gcPath("gofree5gc/support/TLS/nssf.pem")
	NSSF_KEY_PATH = path_util.Gofree5gcPath("gofree5gc/support/TLS/nssf.key")
)

// Default configuration file
var DEFAULT_CONFIG string = "gofree5gc/config/nssfcfg.conf"
